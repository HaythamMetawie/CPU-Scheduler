...
namespace CPUScheduler 
{
    class Algorithms
    {
        ...
        public static double FCFS(List<process> p)
        {       
        ...
        public static double RoundRobin(double q, List<process> p)
        {
            double totalburst = 0.0;
            LinkedList<process> sorted_processes = new LinkedList<process>();
            List<process> SortedList = p.OrderBy(a => a.getArrival()).ToList();
            ...
            return (waitingtimeround / totaljobs);

        }
        public static double NonPreemptive_SJF(List<process> p)
        {
            LinkedList<process> sorted_processes = new LinkedList<process>();
        ...
        public static double NonPreemptive_Priority(List<process> p)
        {
            LinkedList<process> sorted_processes = new LinkedList<process>();
        ...
        public static double Preemptive_SJF(List<process> p)
        {
            LinkedList<process> sorted_processes = new LinkedList<process>();
